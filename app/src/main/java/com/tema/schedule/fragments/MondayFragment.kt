...
class MondayFragment : Fragment() {
    ...
    private fun mondayScheduleFill() {
        mondaySchedule.add(mutableListOf("9:00 - 10:30", "МСпорт.Зал", "Элективные курсы по физической культуре и спорту (Практика)", ""))
        mondaySchedule.add(mutableListOf("10:40 - 12:10", "Пр2306", "Деловая этика (Лекция)", "Отц Екатерина Викторовна"))
        mondaySchedule.add(mutableListOf("12:20 - 13:50", "Пр2306", "Основы современных алгоритмов (Лекция)", "Арсентьев Дмитрий Андреевич"))
    }
}